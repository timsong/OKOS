...
namespace WFS.Domain.Managers
{
    public class OrganizationManager
    {
        ...
        public CreateOrganizationResponse CreateOrganization(CreateOrganizationRequest request)
        {
            ...
            //Create WFS User
            var wfsComm = new CreateWFSUserCommand((Guid)newMem.ProviderUserKey, request.FirstName, request.LastName, (request.ParentOrgId.HasValue) ? WFSUserTypeEnum.Store.ToString() : WFSUserTypeEnum.Vendor.ToString());
        ...
        private CreateOrganizationResponse HandleMembershipCreationError(MembershipCreateStatus memStat)
        {
            var msg = new Message();
